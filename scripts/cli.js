...
const contractABI = require("../artifacts/contracts/Chainmosaic.sol/Chainmosaic.json").abi;

program
    .name("chainmosaic-cli")
    .description("CLI tool for Chainmosaic smart contract")
    .version("1.0.0");
